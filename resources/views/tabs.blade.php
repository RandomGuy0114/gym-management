...
<ul class="nav bg-secondary text-dark align-items-end justify-content-center row">
    ...
    <li class="nav-item bg-light col">
        <a class="nav-link fw-bold text-dark text-center" href="{{ route('delete') }}">Delete</a>
    </li>
</ul>
